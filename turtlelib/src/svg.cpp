...
namespace turtlelib
{
    ...
    void Svg::draw_point(std::ofstream &svgFile, Point2D &p, const std::string &stroke_color, const std::string fill_color){
        ...
        svgFile<<"<circle cx=\""<<pt.x<<"\" cy=\""<<pt.y<<"\" r=\"3\" stroke=\""<<stroke_color<<"\" fill=\""<<fill_color<<"\" stroke-width=\"1\"/>"<<std::endl;
    }
    ...
    void Svg::draw_frame(std::ofstream &svgFile, Point2D &origin, double &angle,  const std::string &stroke_color_x,  const std::string &stroke_color_y, const std::string &frame_coord){
        ...
        svgFile<<"<g>"<<std::endl;
        svgFile<<"<line x1=\""<<xaxis.x<<"\" x2=\""<<origin.x<<"\" y1=\""<<xaxis.y<<"\" y2=\""<<origin.y<<"\" stroke=\""<<stroke_color_x<<"\" stroke-width=\"5\" marker-start=\"url(#Arrow1Sstart)\" />"<<std::endl;
        svgFile<<"<line x1=\""<<yaxis.x<<"\" x2=\""<<origin.x<<"\" y1=\""<<yaxis.y<<"\" y2=\""<<origin.y<<"\" stroke=\""<<stroke_color_y<<"\" stroke-width=\"5\" marker-start=\"url(#Arrow1Sstart)\" />"<<std::endl;
